...
2. Edit the file, replacing `"ardiansahkembar@yahoo.com"` with your email and `"lampungnetworking"` with your GitHub username in the `Setup Git Configuration` step.
